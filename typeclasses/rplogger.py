...
class PlotRunner(DefaultPlotRunner):
    pass
...
class EventParticipant(DefaultEventParticipant):
    pass


class EventSource(DefaultEventSource):
    pass


class EventCodename(DefaultEventCodename):
    pass
