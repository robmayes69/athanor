...
"""
from features.characters.characters import AthanorCharacter, AthanorPlayerCharacter, AthanorMobileCharacter, DefaultCharacterController
...
class CharacterController(DefaultCharacterController):
    pass