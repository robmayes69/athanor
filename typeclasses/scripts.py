...
from features.core.scripts import AthanorScript, AthanorOptionScript, AthanorGlobalScript
...
class OptionScript(AthanorOptionScript):
    pass


class GlobalScript(AthanorGlobalScript):
    pass
