...
class BucketDB(TypedObject):
    __settingclasspath__ = "modules.jobs.jobs.DefaultBucket"
    __defaultclasspath__ = "modules.jobs.jobs.DefaultBucket"
    __applabel__ = "jobs"
...
class JobDB(TypedObject):
    __settingclasspath__ = "modules.jobs.jobs.DefaultJob"
    __defaultclasspath__ = "modules.jobs.jobs.DefaultJob"
    __applabel__ = "jobs"
...
class JobLinkDB(TypedObject):
    __settingclasspath__ = "modules.jobs.jobs.DefaultJobLink"
    __defaultclasspath__ = "modules.jobs.jobs.DefaultJobLink"
    __applabel__ = "jobs"
...
class JobCommentDB(TypedObject):
    __settingclasspath__ = "modules.jobs.jobs.DefaultJobComment"
    __defaultclasspath__ = "modules.jobs.jobs.DefaultJobComment"
    __applabel__ = "jobs"
