...
_LIST_SETTINGS = ("SERVER_SERVICES_PLUGIN_MODULES", "PORTAL_SERVICES_PLUGIN_MODULES", "INSTALLED_APPS",
                  ...
                  "STATICFILES_DIRS", "OBJECT_MIXINS", "ENTITY_MIXINS", "CHARACTER_MIXINS", "REGION_MIXINS",
                  "ACCOUNT_MIXINS", "STRUCTURE_MIXINS", "SCRIPT_MIXINS", "SESSION_MIXINS",
                  "MAPENT_MIXINS", "AREA_MIXINS", "ROOM_MIXINS", "EXIT_MIXINS", "GATEWAY_MIXINS")
