...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='characterinfo',
            name='info',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='characters', to='storyteller.TemplateInfo'),
        ),
        migrations.AddField(
        ...
        migrations.AlterUniqueTogether(
            name='powercategory',
            unique_together=set([('category', 'kind')]),
        ),
        migrations.AlterUniqueTogether(
            name='power',
